...
function Specials() {
	const specials = [
		...
		},
		{
			...
			title: "Lemon Desert",
			price: "$5.00",
			description: "This comes stright from grandma's recipe book, every last ingredient has been sourced and is authentic as can be imagined.",
		},
		{
			image: bruschetta,
			title: "Bruschetta",
			price: "$5.99",
			description: "Our Bruschetta is made from grilled break that has been smeared with garlic and seasoned with salt and olive oil.",
		},
	];
	...
	return (
		<section id="specials">
			<div id="specials-header">
				...
				<a href="/menu" className="yellow-button">Online Menu</a>
			</div>
